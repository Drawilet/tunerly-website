        ...
        <div className="max-w-2xl mx-auto space-y-6 relative z-10">
          ...
          <div className="pt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-[#0071E3] hover:bg-[#005bb5] text-white font-medium text-base px-8 py-4 rounded-full transition-all shadow-[0_0_35px_rgba(0,113,227,0.4)]"
            >
          ...
          <div className="pt-8 flex flex-col items-center justify-center gap-4">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 opacity-65 grayscale select-none pointer-events-none">
              {/* App Store Badge outline */}
              <div className="flex items-center gap-2 border border-white/20 rounded-xl bg-black px-4 py-2 text-left">
                <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18.71,19.5C17.88,20.74 17,21.95 15.66,21.97C14.32,22 13.89,21.18 12.37,21.18C10.84,21.18 10.37,21.95 9.1,22C7.79,22.05 6.8,20.68 5.96,19.47C4.25,17 2.94,12.45 4.7,9.39C5.57,7.87 7.13,6.91 8.82,6.88C10.1,6.86 11.32,7.75 12.11,7.75C12.89,7.75 14.37,6.68 15.92,6.84C16.57,6.87 18.39,7.1 19.56,8.82C19.47,8.88 17.39,10.1 17.41,12.63C17.44,15.65 20.06,16.66 20.1,16.67C20.08,16.74 19.67,18.11 18.71,19.5M15.97,4.17C16.63,3.37 17.07,2.28 16.95,1C16,1.04 14.9,1.6 14.24,2.38C13.68,3.04 13.19,4.14 13.34,5.39C14.39,5.47 15.4,4.88 15.97,4.17Z" />
                </svg>
                <div>
                  <div className="text-[9px] uppercase tracking-wider text-neutral-300 leading-none">Coming soon on the</div>
              ...
              <div className="flex items-center gap-2 border border-white/20 rounded-xl bg-black px-4 py-2 text-left">
                ...
                <div>
                  <div className="text-[9px] uppercase tracking-wider text-neutral-300 leading-none">Get it soon on</div>
